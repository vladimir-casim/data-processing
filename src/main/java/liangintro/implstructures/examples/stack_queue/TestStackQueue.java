...
public class TestStackQueue {
    ...
    public static void main(String[] args) {
        // Create a stack_queue
        GenericStack<String> stack = new GenericStack<>();

        // Add elements to the stack_queue
        stack.push("Tom"); // Push it to the stack_queue
        System.out.println("(1) " + stack);

        stack.push("Susan"); // Push it to the the stack_queue
        System.out.println("(2) " + stack);

        stack.push("Kim"); // Push it to the stack_queue
        stack.push("Michael"); // Push it to the stack_queue
        System.out.println("(3) " + stack);

        // Remove elements from the stack_queue
